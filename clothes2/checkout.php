                  ...
                  <div class="col-lg-6 col-md-6">
                     <form action="#">
                        ...
                        <div class="row">
                           ...
                           <div class="col-12 mb-30">
                              <label for="b_c_name">Full Name <span>*</span></label>
                           ...
                           <div class="col-12 mb-30">
                              <label for="b_city">Phone number <span>*</span></label>
                  ...
                  <div class="col-lg-6 col-md-6">
                     <div class="order-wrapper">
                        ...
                        <div class="payment-method">
                           ...
                           <a href="thanhtoan.php?tongtien=<?php echo $tongtien ?>"><button  type="submit" alert("Đặt hàng thành công");>To Order</button></a>
                  ...
                  <div class="single_footer_widget_inner">
                     ...
                     <div class="footer_menu">
                        <ul>
                           ...
                           <li><a href="index.php?#spshop">Good</a></li>
                           <li><a href="index.php?#spmoi">Jacket</a></li>
                           <li><a href="index.php?#spbanchay">Best Seller</a></li>
