            ...
            <div class="col-12">
               <div class="header_wrapper_inner">
                  <div class="logo col-xs-12">
                     <a href="index.php">
                     <img src="assets/img/banner/16.jpg" alt="" style="height:100px;">
                     </a>
                  </div>
                  <div class="main_menu_inner">
                     <div class="menu">
                        <nav>
                           <ul >
                              <li class="active"><a href="index.php" style="font-size:14px">Home</a>                                                    
                              </li>
                              <li><a href="about.php" style="font-size:14px">About</a> </li>
                              <li><a href="shop.php" style="font-size:14px">New Arraval</a>  </li>
                              <li><a href="blog.php" style="font-size:14px">Magazine</a>
                              </li>
                     ...
                     <div class="mobile-menu d-lg-none">
                        <nav>
                           ...
                           <li class="active"><a href="index.php" style="font-size:14px">Home</a>                                                    
                              ...
                              <li><a href="about.php" style="font-size:14px">About</a> </li>
                              <li><a href="shop.php" style="font-size:14px">New in</a>  </li>
                              <li><a href="blog.php" style="font-size:14px">Magazine</a>
                              </li>
                              <li><a href="contact.php" style="font-size:14px">Contact us</a></li>
                           </ul>
                  ...
                  <div class="header_right_info d-flex">
                     <div class="search_box">
                        <div class="search_inner">
                              ...
                              <input type="text" placeholder="Searching..." name="tukhoa">
                     ...
                     <div class="mini__cart">
                        ...
                        <?php 
                           ...
                           <div class="mini_cart_item">
                              ...
                              <a href="carts/add.php?id=<?php echo $item['id'];?>&action=delete"><i class="zmdi zmdi-delete"></i></a>
                              </div>
                           </div>
                           <?php 
                                 }
                           ...
                           <div class="language-selector-wrapper">
                              <div class="user_info_top">
                                 <ul>
                                    ...
                                    <?php
                                          if(isset($_SESSION['login'])){ ?>
                                             <li><a href="my-account.php">Hello     
                                    ...
                                    <?php
                                       if(isset($_SESSION['login'])){
                                          echo '<li hidden><a href="login.php">Sign In</a></li>';
                                       }else{
                                    ...
                                    ?>      
                                      <?php
                                       if(!isset($_SESSION['login'])){
                                          echo '<li hidden><a href="login.php?action=dangxuat">Sign Out</a></li>';
                                       }else{
                                          echo '<li><a href="login.php?action=dangxuat">Sign Out</a></li>';
                                       }
                                    ?> 
