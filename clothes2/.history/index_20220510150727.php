    ...
    <body>
                ...
                <div class="slider_area">
                    <div class="slider_list  owl-carousel">
                        <div class="single_slide" style="background-image: url(assets/img/slider/5.png)">
                            <div class="container">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="slider__content">
                                            <p style="padding-left: 150px; color: white;">Exclusive Offer -10% Off This Week</p>
                                            <h2 style="padding-left: 150px; color: white;">Find your <strong style="color: white;">FAVORITE</strong> outfit</h2>
                                            <h3 style="padding-left: 150px; color: white;">all <strong style="color: white;s>New</strong> everything</h3>  
                        ...
                        <div class="single_slide" style="background-image: url(assets/img/slider/6.jpg);">
                            <div class="container">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="slider__content">
                                            <p style="padding-left: 250px; padding-top:200px; color:#14bcec ">Exclusive Offer -10% Off This Week</p>
                                            <h2 style="padding-left: 250px">We <strong>provide</strong> the best</h2> 
                                            <h3 style="padding-left: 250px"> product <strong> for you </strong></h3>
                                ...
                                <div class="shop_larg_product">
                                    <div class="single__product_2">
                                        ...
                                        <div class="product__content text-center">
                                            ...
                                            <?php if($sh->soluong != 0){?>
                                                <a href="carts/add.php?id=<?php echo $sh->id;?>&groupid=<?php echo $sh->groupid;?>">Thêm sản phẩm</a>
                                            <?php }else{ ?>         
                                                <a >Thêm sản phẩm</a>
                                            <?php }?>
                                            </div>
