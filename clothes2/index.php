<?php
    include('connect.php');
    $products = $db->query("SELECT * FROM product WHERE (groupid = 1) OR (groupid = 4) or (groupid = 5) Order By  id ASC LIMIT 15");
    $productnew = $db->query("SELECT * FROM product WHERE groupid = 2 LIMIT 15");
    $productshop = $db->query("SELECT * FROM product WHERE groupid = 1 Order By  id DESC");
    $productshopfresh = $db->query("SELECT * FROM product WHERE groupid = 1 Order By  id ASC");
    $productshophuuco = $db->query("SELECT * FROM product WHERE groupid = 4");
    $productshoporga = $db->query("SELECT * FROM product WHERE groupid = 6");
...
<head>
        <title>Breyers Store - eCommerce Bootstrap4 Template</title>
        <?php
    ...
    <body>
                ...
                <div class="slider_area">
                    <div class="slider_list  owl-carousel">
                        <div class="single_slide" style="background-image: url(assets/img/slider/15.jpg)">
                            <div class="container">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="slider__content">
                                            <p style="padding-left: 150px; color: red;">Exclusive Offer -10% Off This Week</p>
                                            <h2 style="padding-left: 150px; color: black;">Find your <strong style="color: gray;">FAVORITE</strong> outfit</h2>
                                            <h3 style="padding-left: 150px; color: black;">all <strong style="color: gray;">New</strong> everything</h3>  
                        ...
                        <div class="single_slide" style="background-image: url(assets/img/slider/6.jpg);">
                            <div class="container">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="slider__content">
                                            <p style="padding-left: 250px; padding-top:200px; color:#CAC04F ">Exclusive Offer <strong style="color:#E3382C">-10% Off</strong> This Week</p>
                                            <h2 style="padding-left: 250px; color:white">We <strong style="color:white">provide</strong> the best</h2> 
                                            <h3 style="padding-left: 250px; color:white"> product <strong style="color:white"> for you </strong></h3>
                                                ...
                                                <div class="product__content text-center">
                                                    ...
                                                    <div class="product__hover">
                                                        <ul>
                                                            ...
                                                            <li><a href="carts/add.php?id=<?php echo $pro->id;?>&groupid=<?php echo $pro->groupid;?>"><i class="ion-android-cart"></i></a></li> 
                                                            <?php }else{ ?>         
                                ...
                                <div class="shipping_list d-flex justify-content-between flex-xs-column">
                                    <div class="single_shipping_box d-flex">
                                        ...
                                        <div class="shipping_content">
                                            <h6>Free Premium Express Shipping</h6>
                                            <p>with bill over 1.000.000 VND</p>
                                        </div>
                                    </div>
                                    <div class="single_shipping_box one d-flex">
                                        ...
                                        <div class="shipping_content">
                                            <h6>Refund in 7 days</h6>
                                            <p>if the product is defectived</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="single_shipping_box three d-flex">
                                        ...
                                        <div class="shipping_content">
                                            <h6 style="margin-top: 15px;">Digital Showroom Experience</h6> 
                                            <p>suport 24/7</p>                                         
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="section_title text-center">
                                     ...
                                     <div class="home_shop_product text-right">
                                        <ul class="product-tab-list nav d-flex flex-wrap justify-content-end" role="tablist">
                                            ...
                                            <li><a href="#organics" data-toggle="tab" role="tab" aria-selected="false" aria-controls="organics">Pants/Access </a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div> 
                                    ...
                                    <div class="single__product_2">
                                        <div class="product_img">
                                            <a href="product-details.php?id=<?php echo $sh->id;?>&groupid=<?php echo $sh->groupid;?>">
                                                <img style="padding: 0px"src="assets/img/product/<?= $sh->image ?>"" alt="">
                                            </a>
                                        </div>
                                        <div class="product__content text-center">
                                            <div class="product_title">
                                            ...
                                            <?php if($sh->soluong != 0){?>
                                                <a href="carts/add.php?id=<?php echo $sh->id;?>&groupid=<?php echo $sh->groupid;?>">Add to cart</a>
                                            <?php }else{ ?>         
                                                <a >Add to cart</a>
                                            <?php }?>
                                            </div>
                                                                    ...
                                                                    <div class="product__hover">
                                                                        <ul>
                                                                            ...
                                                                            <!-- <?php if($proshop->soluong != 0){?>
                                                                                <li><a href="carts/add.php?id=<?php echo $proshop->id;?>&groupid=<?php echo $proshop->groupid;?>"><i class="ion-android-cart"></i></a></li>
                                                                            <?php }else{ ?>         
                                                                    ...
                                                                    <div class="product__hover">
                                                                        <ul>
                                                                            ...
                                                                            <!-- <?php if($proshopfresh->soluong != 0){?>
                                                                                <li><a href="carts/add.php?id=<?php echo $proshopfresh->id;?>&groupid=<?php echo $proshopfresh->groupid;?>"><i class="ion-android-cart"></i></a></li>
                                                                            <?php }else{ ?>         
                                                                                <li><a><i class="ion-android-cart"></i></a></li>
                                                                            <?php }?>   -->
                                                                    ...
                                                                    <div class="product__hover">
                                                                        <ul>
                                                                            ...
                                                                            <!-- <?php if($proshophuuco->soluong != 0){?>
                                                                                <li><a href="carts/add.php?id=<?php echo $proshophuuco->id;?>&groupid=<?php echo $proshophuuco->groupid;?>"><i class="ion-android-cart"></i></a></li>
                                                                            <?php }else{ ?>         
                                                                                <li><a><i class="ion-android-cart"></i></a></li>
                                                                            <?php }?>   -->
                                                                    ...
                                                                    <div class="product__hover">
                                                                        <ul>
                                                                            ...
                                                                            <!-- <?php if($proshoporga->soluong != 0){?>
                                                                                <li><a href="carts/add.php?id=<?php echo $proshoporga->id;?>&groupid=<?php echo $proshoporga->groupid;?>"><i class="ion-android-cart"></i></a></li>
                                                                            <?php }else{ ?>         
                                                                                <li><a><i class="ion-android-cart"></i></a></li>
                                                                            <?php }?>   -->
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="single_banner">
                                    <a href="#">
                                        <img src="assets/img/banner/12.png" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                                                    ...
                                                    <div class="product__hover">
                                                        <ul>
                                                            ...
                                                            <!-- <?php if($pronew->soluong != 0){?>
                                                                <li><a href="carts/add.php?id=<?php echo $pronew->id;?>&groupid=<?php echo $pronew->groupid;?>"><i class="ion-android-cart"></i></a></li>
                                                            <?php }else{ ?>         
                                                                <li><a><i class="ion-android-cart"></i></a></li>
                                                            <?php }?>  -->
