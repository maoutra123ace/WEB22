			...
			<div class="breadcrumb_container">
				<div class="container-fluid">
					<div class="row">
						...
						<ul>
							<li>
								<a style="color: #f24c74" href="index.php"><strong>Home</strong> </a><a>></a>
							</li>
							<li>New Arrival</li>
						</ul>
					</nav>
									...
									<div class="search_filters_wrapper">
									    <div class="price_filter widget">
											...
											<div class="search_filters widget">
												...
												<input style="color: black" type="text" name="text" id="amount" />    
											</div>
									    </div>    
									</div>
                                </div>
                            ...
                            <div class="col-lg-3 col-md-12 col-xs-12">
                                ...
                                <div class="single_footer_widget_inner">
                                    <div class="footer_logo">
                                        <a href="index.php"><img src="assets/img/banner/16.jpg" alt="" style="height:80px"></a>
                                    </div>
