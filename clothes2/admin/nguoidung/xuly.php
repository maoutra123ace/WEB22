    ...
    if(isset($_POST['themuser'])){
        ...
        if(mysqli_num_rows($result) == 0){
            if(mysqli_num_rows($result1)==0){
                $sql_them = "INSERT INTO user(id,name,address,phone,username,password,created_at,updated_at,
                tinhtrang,position) VALUE('".$iduser."','".$tenuser."','".$address."','".$phone."','".$username."',
                '".$pass."','".$created_at."','".$created_at."',0,'".$position."')";
        ...
        if(isset($_GET['query'])=='xoa'){
            $id = $_GET['iduser'];
                ...
                echo "<script>alert('Bạn co muốn xóa!!!');
