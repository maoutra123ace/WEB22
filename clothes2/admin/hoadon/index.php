                                            ...
                                            ?>
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td><?php if($resultHD['cart_status'] == 1){ 
                                                        ?>
                                                        <a href="xuly.php?code=<?php echo $resultHD['Id']; ?>" onclick="return confirm('Có nhận đơn hàng này');">Đơn hàng mới(Xác nhận)</a>
                                                        <?php }
                                                    ...
                                                    <?php if($resultHD['cart_status'] == 1){    ?>
                                                        <a href="xoa.php?id=<?php echo $resultHD['Id'] ?>" onclick=" return confirm('Có chắc sẽ hủy đơn hàng này?');" >Hủy đơn đặt hàng</a>
                                                    <?php }?>
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button type="button" class="btn btn-warning disabled">In đơn hàng</button>
