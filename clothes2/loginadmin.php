<?php
   ...
   if(isset($_POST['login'])){
      ...
      if(mysqli_num_rows($row) > 0){
         ...
         echo "<script>alert('Tài khoản hoặc mật khẩu không đúng. Nhập lại!!!');
                window.location='loginadmin.php';
                </script>";        
      }
   }  
                        ...
                        <?php if(isset($alert)):?>
                           ...
                           <div class="col-12">
                              <div class="login_submit">
                                 <input class="inline" value="Sign In" name="login" type="submit">
                           ...
                           <p style="padding-top: 15px; padding-left:140px; color:gray;">Create Account Now 
                           <i class="fas fa-hand-point-right"></i> 
                           <a href="register.php" style="color: black;">REGISTER</a></p>
                        </div>
                     </form>
